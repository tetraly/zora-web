...
COMMUNITY_HINTS = {
    HintType.WOOD_SWORD: [
        "THIS IS THE ZELDA|ONE RANDOMIZER|FOR ALL",
    ...
    HintType.POTION_SHOP : [
      ...
      "ASK YOUR DOCTOR IF|MAGIC IS RIGHT FOR YOU",
    ...
    HintType.PAY_ME: ["ARE THESE HINTS|VANILLA? BUY ONE|  TO FIND OUT",],
    HintType.PAY_ANSWER_1: ["NO",],
    ...
    HintType.HUNGRY_ENEMY: [
        ...
        "Do you prefer|bacon, pork,|or ham?"
    ],
    HintType.OTHER: [
    ...
    HintType.BOMB_UPGRADE: [
      "I'm BOMB BARKER|please have your pet|spayed or neutered!",
      "SPLOOSH!|KABOOM!",
    ...
    HintType.MUGGER: [
      "GENDER ISN'T A BINARY|BUT THIS CHOICE IS",
      "SUGGEST MUGGER QUOTES|IN THE ZORA DISCORD",
    ...
    HintType.FRENCH : [
      ...
      #"I'VE GOT FOUR TWENTIES|TEN-NINE PROBLEMS|AND COUNTING AINT ONE!",
...
class TextDataTable():
  ...
  def NewGenerateTestingString(self, num: int) -> List[int]:
    ...
    elif num in range (19, 34) and not hint_type in [HintType.BOMB_UPGRADE, HintType.MUGGER]:
